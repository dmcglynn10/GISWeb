        ...
        protected void gvListOfCurrentAreas_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                using (GISEntities context = new GISEntities())
                {
                    ...
                    string[] commandArgs = tooltipArray[e.Row.RowIndex].ToString().Split(new string[] { "<div>", "</div>" }, StringSplitOptions.None);
                    ...
                    e.Row.Cells[9].Text = commonPostcode.ToUpper(); //assign resulting postcode to gridview column 'Postcodes'
